...
- Optional role and named-agent catalog (`docs/agent-catalog.md`). Launches resolve through the existing subagent runtime (`docs/agent-catalog-lifecycle.md`, `docs/agent-model-resolution.md`).
