...
## [pi-better-plan@0.1.1] - 2026-09-12
...
- **harness**: include `pi-better-plan@0.1.1` in the bundled extension set and standalone installer with `update_plan`, `get_plan`, and `/plan`
