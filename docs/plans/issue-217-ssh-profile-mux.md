...
| `ssh_mux status/stop` handles a target and all known current-session masters through fake-runner control argv | mux controls | in-progress | RED mux registry/tool tests pending |
