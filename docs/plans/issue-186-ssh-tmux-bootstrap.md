...
| Coverage and close-out gates | generated evidence and PR contract | done | smoke/checklist/lints/scan pass; inherited inventory and CI-adoption blockers recorded in `docs/tests/_generated/coverage-checklist-186.md` |
