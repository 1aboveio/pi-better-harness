...
| Coverage and close-out gates | generated evidence and PR contract | in-progress | runtime smoke passed at `docs/tests/_generated/runtime-smoke-results-186.json`; final gates pending |
